...
typedef enum
{
    ...
    HIGH_SETTING_DIF,
    HIGH_SETTING_POF,
    HIGH_SETTING_SENSOR_TYPE,
    HIGH_SETTING_LIF,
    HIGH_SETTING_COMFORTABLE_SET_TEMP,
    HIGH_SETTING_SAVE_SET_TEMP,
    HIGH_SETTING_OUTPUT_OPEN_TIME,
    HIGH_SETTING_OUTPUT_CLOSE_TIME,
    HIGH_SETTING_LTP,
...
typedef struct
{
    ...
    int16_t                sunSetTemp            ;
    int16_t                moonSetTemp           ;
    uint8_t                outputOpenLastTime    ;
    uint8_t                outputCloseLastTime   ;
    int16_t                lifSetTemp            ; 
    int16_t                ltpSetTemp            ;
